...
export default function Home() {
  ...
  const sessions: Session[] = useMemo(() => (Array.isArray(dataSessions) ? dataSessions : []), [dataSessions]);
  ...
  return (
    <div className="space-y-12">
      ...
      {!sessionsLoading && nextSession ? (
        <section className="rounded-3xl bg-gray-200 dark:bg-gray-900 border border-gray-400 dark:border-gray-800 p-6 shadow-sm">
  ...
  className="rounded-2xl dark:bg-green-500/30 bg-gray-100 text-center p-4 hover:ring-2 hover:ring-cyan-500 transition-all ring-roup cursor-pointer block"
>
                ...
                <p className="text-sm mt-2 text-cyan-800 dark:text-cyan-400 font-semibold">Ir directo a la sesión →</p>
              </Link>
