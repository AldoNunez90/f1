...
export function DocumentCard({
  ...
  return (
    <div
      className="group block overflow-hidden rounded-3xl border border-gray-200 bg-slate-50 shadow-sm transition hover:-translate-y-1 hover:shadow-xl hover:border-cyan-400 dark:border-gray-800 dark:bg-slate-950 cursor-pointer"
    >
      <div className="p-6">
